...
>(
  ...
  expect(a.isError).toStrictEqual(b.isError);
  expect(a.isIdle).toStrictEqual(b.isIdle);
  expect(a.isSuccess).toStrictEqual(b.isSuccess);
  expect(a.isFetching).toStrictEqual(b.isFetching);
};
